...
## Jour 8 - Seed de démonstration

### Ce qui fonctionne
- Ajout d'un script de seed backend
- Création automatique d'un compte ADMIN de test
- Création automatique d'un compte USER de test
- Ajout automatique de services de démonstration dans le catalogue
- Réduction des manipulations manuelles dans Mongo Express

### Ce qui reste à faire
- Ajouter éventuellement une route admin pour consulter toutes les réservations
- Démarrer le frontend React
- Créer les pages login, catalogue et réservation
- Ajouter les tests API
- Préparer Jenkins et GitHub Actions

### Décision technique
- Les comptes seed sont uniquement destinés au développement local
- Le seed est réexécutable sans dupliquer les utilisateurs et services existants